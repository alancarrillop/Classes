COVID19MExico_DatosAbiertos_Codificaciones<-function()
  ...
  ESTADO<-read.csv(text=getURL("https://raw.githubusercontent.com/alancarrillop/Classes/master/Teacher/DisenoExperimental_sep2020/BD/COVID19/InputFiles/COVID19Mexico_DatosAbiertos_CodificacionEstados.csv"))
  ...
  MUNICIPIO<-read.csv(text=getURL("https://raw.githubusercontent.com/alancarrillop/Classes/master/Teacher/DisenoExperimental_sep2020/BD/COVID19/InputFiles/COVID19Mexico_DatosAbiertos_CodificacionMunicipios.csv"))
